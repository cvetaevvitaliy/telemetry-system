 ...
 *
 * \remark RADIO_INIT_REGISTERS_VALUE is defined in radio.h file
 */
 ...
 * Tx and Rx timers
 */
TimerEvent_t TxTimeoutTimer = {.id = TIMER_TxTimeout};
TimerEvent_t RxTimeoutTimer = {.id = TIMER_RxTimeout};
TimerEvent_t RxTimeoutSyncWord = {.id = TIMER_RxTimeoutSyncWord};
...
void SX1276Init( RadioEvents_t *events )
{
    ...
    TimerInit( &TxTimeoutTimer );
    TimerInit( &RxTimeoutTimer );
    TimerInit( &RxTimeoutSyncWord );
    ...
    case MODEM_LORA:
        {
            ...
            {
                SX1276Write( REG_LR_DETECTOPTIMIZE,( SX1276Read( REG_LR_DETECTOPTIMIZE ) &
                                                RFLR_DETECTIONOPTIMIZE_MASK ) |
                                                RFLR_DETECTIONOPTIMIZE_SF7_TO_SF12 );
                SX1276Write( REG_LR_DETECTIONTHRESHOLD,
                             RFLR_DETECTIONTHRESH_SF7_TO_SF12 );
