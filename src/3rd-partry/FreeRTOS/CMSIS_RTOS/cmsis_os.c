...
* @param millisec      timeout value or 0 in case of no time-out.
* @retval  status code that indicates the execution status of the function.
* @note   MUST REMAIN UNCHANGED: \b osMutexTake shall be consistent in every CMSIS-RTOS.
*/
osStatus osMutexTake (osMutexId mutex_id, uint32_t millisec)
{
  TickType_t ticks;
  portBASE_TYPE taskWoken = pdFALSE;  
...
/**
* @brief Release a Mutex that was obtained by \ref osMutexTake
* @param mutex_id      mutex ID obtained by \ref osMutexCreate.
* @retval  status code that indicates the execution status of the function.
...
* @note   MUST REMAIN UNCHANGED: \b osSemaphoreTake shall be consistent in every CMSIS-RTOS.
*/
int32_t osSemaphoreTake (osSemaphoreId semaphore_id, uint32_t millisec)
{
  TickType_t ticks;
  portBASE_TYPE taskWoken = pdFALSE;  
